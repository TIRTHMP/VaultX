...
A biometric-secured mobile vault for storing payment card details safely.
Built with React Native (Expo) and production-ready architecture.
...
Master biometric lock before accessing vault

Individual card biometric verification
...
App Name: VaultX
Design Philosophy: Minimal • Secure • Fintech-inspired
...
Tirth Patel
BTech CSE | Software Developer | AI & Backend Enthusiast
